        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-brand-600 max-w-3xl mx-auto leading-relaxed">
              Ready to bring your vision to life? Tell us about your project and let's create 
              something amazing together. We typically respond within 1-2 business days.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <Card className="relative overflow-hidden bg-gradient-to-br from-brand-900 to-brand-800 border-0 text-white">
              ...
              <div className="relative p-8 lg:p-12 space-y-6">
                ...
                <p className="text-xl opacity-90 max-w-2xl mx-auto">
                  Feel free to reach out directly via email or connect with us on social media. 
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                  <Button 
                    variant="gradient" 
                    size="lg"
                    onClick={() => window.location.href = 'mailto:hello@milehighinterface.com'}
                  >
